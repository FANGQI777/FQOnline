    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.CharField(choices=[('junior', '初级'), ('medium', '中级'), ('senior', '高级')], max_length=10, verbose_name='课程级别')),
                ('learn_times', models.IntegerField(default=0, verbose_name='学习市场-->分钟数')),
                ('student_numbers', models.IntegerField(default=0, verbose_name='学习人数')),
                ('collection_numbers', models.IntegerField(default=0, verbose_name='收藏人数')),
